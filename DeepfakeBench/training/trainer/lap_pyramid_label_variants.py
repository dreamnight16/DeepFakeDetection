"""
Laplacian Pyramid Mixup — 2×2 Factorial Ablation
=================================================
Four variants generated by crossing two binary factors:
...
2×2 combinations:
  ┌──────────┬───────────────────┬───────────────────┐
  │          │  mix_scope = top  │ mix_scope = bottom│
  ├──────────┼───────────────────┼───────────────────┤
  │ label=0  │  (1) G_K, ỹ=0     │  (2) L_0, ỹ=0     │
  │ label=1  │  (3) G_K, ỹ=1     │  (4) L_0, ỹ=1     │
  └──────────┴───────────────────┴───────────────────┘
